...
1. Asghar Ghori - Sample RHCSA Exam 3
	...
	* Build 2 virtual machines with RHEL 8 Server for GUI. Add a 10GB disk for the OS and use the default storage partitioning. Add 1 400GB to VM1 and 2 100GB disks to VM2. Assign a network interface, but do not configure the hostname and network connection.
